...
import CardFooterStories from './CardFooter.stories';
import Card, {
	CardActions,
	CardBody,
	CardFooter,
...
export default {
	...
	argTypes: {
		...CardFooterStories.argTypes,
		children: { control: false, table: { category: 'Card', subcategory: 'CardFooter' } },
	},
	args: { ...CardFooter.defaultProps },
};
