...
import CardHeaderStories from './CardHeader.stories';
import Card, {
	CardActions,
	CardBody,
	CardFooter,
...
export default {
	...
	argTypes: {
		...CardHeaderStories.argTypes,
		children: { control: false, table: { category: 'Card', subcategory: 'CardHeader' } },
	},
	args: {
		...CardHeaderStories.args,
		borderSize: 1,
	},
};
