...
type TTabs = 'Infos' | 'Comments' | 'Edit';
interface ITabs {
	[key: string]: TTabs;
}
...
const ProductViewPage = () => {
	...
	return (
		<PageWrapper
		//  title={demoPagesMenu.sales.subMenu.product.text}
		>
			<SubHeader>
				<SubHeaderLeft>
				...
				<SubHeaderRight>
					<span className='text-muted fst-italic me-2'>{t('Last update')}:</span>
					<span className='fw-bold'>13 {t('hours ago')}</span>
				</SubHeaderRight>
			</SubHeader>
			<Page>
													...
													<CardHeader className='bg-transparent'>
														<CardLabel>
															<CardTitle tag='h4' className='h5'>
																Montant du don sur{' '}
																{data.series[0].data.length} mois
															</CardTitle>
														</CardLabel>
													</CardHeader>
