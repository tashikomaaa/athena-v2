		...
		<div className='row'>
			...
			<div className='col-md-7 d-flex align-items-center'>
				<div>
					...
					<p>Vous pouvez changer entre le dark et le light mode.</p>
				</div>
			</div>
			<TourNavigation />
		</div>
	...
	return (
		<div className='row'>
			...
			<div className='col-md-8 d-flex align-items-center'>
				<div>
					<p className='lead'>Changement de langue</p>
					<p>
						Ne couvre pas encore tout le site, mais sera disponible dans les prochaine
						versions.
					</p>
				</div>
			</div>
...
const SearchTour = () => {
	...
	return (
		<div className='row'>
			...
			<div className='col-md-8 d-flex align-items-center'>
				<div>
					<p className='lead'>Recherche</p>
					<p>Vous pouvez chercher n'importe quoi ici.</p>
					<ol>
						<li>
							Chercons le mot <b>"Donateurs"</b> par exemple.
						</li>
						<li>
							Ensuite cliquez sur le mot <b>"Donateurs"</b> dans les résultats.
						</li>
					</ol>
				</div>
			</div>
...
// 						<p>The designs of the added packages are compatible with "Athena".</p>
// 						<p>
...
const ListPageTour = () => {
	...
	return (
		<div className='row'>
			...
			<div className='col-md-8 d-flex align-items-center'>
				<div>
					<p className='lead'>Pages Listes des bulletins</p>
					<p>La page des bulletins est peut être la plus importante.</p>
					<p>
						Cliquez sur <b>{t('All List')}</b> button to see some details.
					</p>
				</div>
			</div>
		</div>
		...
		<div className='row'>
			...
			<div className='col-md-8 d-flex align-items-center'>
				<div>
					...
					<p>
						Some sample screens have been made with "Athena" and it can give you an idea
						for your project.
					</p>
					<p>
		...
		<div className='row'>
			...
			<div className='col-md-8 d-flex align-items-center'>
				<div>
					...
					<p>Here you can find detailed usage of ui and form components for Athena.</p>
				</div>
			</div>
			<TourNavigation />
		</div>
				...
				<div className='row'>
					...
					<div className='col-auto'>
						<Button
							...
							isLight
							tag='a'
							href='https://1.envato.market/athena-preview'>
							Buy Now
						</Button>
					</div>
				</div>
